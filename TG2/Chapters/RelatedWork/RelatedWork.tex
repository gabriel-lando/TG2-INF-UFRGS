Nesta seção, são analisados alguns estudos publicados com relação a testes em redes móveis.
...
O trabalho de \cite{Boano2018} não está diretamente relacionado com a proposta do presente trabalho de graduação.
