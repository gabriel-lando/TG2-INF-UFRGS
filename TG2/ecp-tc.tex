...
\input{TG2/Chapters/0.1.Acknowledgements}


% resumo na língua do documento
\begin{abstract}
\input{TG2/Chapters/0.2.Resumo}
\end{abstract}
...
\input{TG2/Chapters/0.3.Abstract}
\end{englishabstract}
...
\chapter{Introdução}
\label{chap:intro}
\input{TG2/Chapters/Introduction/Introduction}

\chapter{Fundamentação teórica}
\label{chap:background}
\input{TG2/Chapters/Background/Background}

\chapter{Trabalhos relacionados}
\label{chap:related}
\input{TG2/Chapters/RelatedWork/RelatedWork}

\chapter{Solução}
\label{chap:soluction}
\input{TG2/Chapters/Soluction/Soluction}

\chapter{Análise dos dados coletados}
\label{chap:results}
\input{TG2/Chapters/DataAnalysis/DataAnalysis}

\chapter{Considerações finais e trabalhos futuros}
\label{chap:conclusion}
\input{TG2/Chapters/Conclusion/Conclusion}
